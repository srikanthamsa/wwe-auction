    ...
    <div style={{ position:'relative', zIndex:1, minHeight:'100vh', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:'2rem 1.5rem', fontFamily:'Outfit, sans-serif' }}>
      ...
      <div style={{ width:'100%', maxWidth:500, animation:'fadeUp 0.5s ease' }}>
        ...
        <div style={{ textAlign:'center', marginBottom:'3rem' }}>
          ...
          <div style={{ fontSize:'0.8rem', letterSpacing:'0.5em', color:'rgba(30,41,59,0.45)', marginTop:'0.5rem', textTransform:'uppercase' }}>
          ...
          <div style={{ marginTop:'0.75rem', display:'flex', alignItems:'center', justifyContent:'center', gap:'0.6rem' }}>
            ...
            <span style={{ fontSize:'0.62rem', letterSpacing:'0.25em', color:'rgba(30,41,59,0.3)' }}>
        ...
        <div style={{ marginBottom:'1rem' }}>
          <div style={{ fontSize:'0.65rem', letterSpacing:'0.4em', color:'rgba(30,41,59,0.4)', marginBottom:'1rem', textTransform:'uppercase', textAlign:'center' }}>Who are you?</div>
              ...
              return (
                <button key={p} className="player-btn" onClick={() => setSelected(p)}
                  style={{
                    ...
                    background: active ? `rgba(${rgb},0.14)` : 'rgba(15,23,42,0.04)',
                    boxShadow: active
                  ...
                  <div style={{ fontFamily:'Bebas Neue', fontSize:'1.25rem', letterSpacing:'0.1em', color: active ? col : 'rgba(15,23,42,0.45)', lineHeight:1.1 }}>
                    {disp.first}
                  </div>
                  <div style={{ fontSize:'0.62rem', letterSpacing:'0.06em', color: active ? `rgba(${rgb},0.7)` : 'rgba(30,41,59,0.25)', marginTop:'0.15rem', lineHeight:1.3 }}>
                    {disp.gimmick}
                  </div>
                </button>
              )
        ...
        {isActive ? (
          ...
          <div style={{ textAlign:'center', padding:'1rem', fontSize:'0.9rem', color:'rgba(30,41,59,0.35)', letterSpacing:'0.15em' }}>
          ...
          <div style={{ marginTop:'1.5rem', textAlign:'center' }}>
            {!confirmReset ? (
              <button onClick={() => setConfirmReset(true)}
                style={{ background:'none', border:'none', fontSize:'0.65rem', letterSpacing:'0.2em', color:'rgba(30,41,59,0.2)', cursor:'pointer', textTransform:'uppercase', fontFamily:'Outfit' }}>
                Reset Auction
              </button>
            ) : (
              <div style={{ display:'flex', gap:'0.75rem', justifyContent:'center', alignItems:'center' }}>
                <span style={{ fontSize:'0.8rem', color:'rgba(30,41,59,0.45)', letterSpacing:'0.1em' }}>Sure? Wipes everything.</span>
                ...
                <button onClick={() => setConfirmReset(false)}
                  style={{ background:'none', border:'none', fontSize:'0.78rem', color:'rgba(30,41,59,0.25)', cursor:'pointer', fontFamily:'Outfit' }}>
                  Cancel
                </button>
              </div>
            )}
